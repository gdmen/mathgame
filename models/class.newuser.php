	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				//Insert default problem settings into settings and game_state tables
        $stmts = array(
          $mysqli->prepare("INSERT INTO settings VALUES (?,1,1,0,10,0,19)"),
          $mysqli->prepare("INSERT INTO settings VALUES (?,2,0,0,10,0,10)"),
          $mysqli->prepare("INSERT INTO settings VALUES (?,3,0,0,10,0,100)"),
          $mysqli->prepare("INSERT INTO settings VALUES (?,4,0,1,10,1,10)"),
          $mysqli->prepare("INSERT INTO game_state VALUES (?,102,0,10)")
        );
